...
export const metadata = generateSeoMetadata({
  title: "Serverless Development Expert | AWS Lambda & Vercel Specialist - Mark Tellez",
  description: "Hire a serverless development expert with extensive experience in AWS Lambda, Vercel, and cloud-native architectures. Building scalable, cost-effective solutions with minimal operational overhead.",
  keywords: ["serverless development", "AWS Lambda", "Vercel", "cloud-native", "serverless architecture", "AWS expert", "serverless functions", "event-driven architecture"],
  url: "https://marktellez.com/i-know/serverless-development",
  type: "article",
  siteName: "Mark Tellez - Expert Programmer and AI Engineer"
});

export default function ServerlessDevelopmentSkillPage() {
  return (
    <div className="container mx-auto py-8">
      <div>
        <h1 className="text-white">Serverless Development: Cloud-Native Architecture Expertise</h1>

        <p className="text-gray-300">My serverless development experience spans platforms like AWS Lambda and Vercel, enabling me to build highly scalable applications with minimal operational overhead. I've architected solutions that automatically scale with demand, reduce infrastructure costs, and accelerate development cycles through simplified deployment workflows.</p>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div className="text-lg md:text-xl leading-relaxed text-white">
                Event-driven architectures that process requests asynchronously
              </div>
            </div>
            <div className="flex items-start gap-4">
              <svg className="w-6 h-6 text-white mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
          ...
          <div className="bg-gray-900/30 p-5 rounded-lg border border-white/10">
            ...
            <p className="text-sm text-gray-300">Optimized for frontend applications and <Link href="/i-know/nextjs">NextJS</Link> deployments with integrated CI/CD, edge functions, and global CDN distribution for maximum performance.</p>
          </div>
        </div>
